...
public class ExcelService {
    ...
    public Map<String, Object> downloadSampleSRExcel(Long grade, Long section, Long medium, Long academic, Long school, String fileType) {
        ...
        try {
            ...
            ByteArrayInputStream excelFile = excelFileHandler.LoadSampleSRFile("Academic_Students_SR_Sample_File.xlsx", academicStudentList, mediumGradeSection, fileType);
    ...
    public Map<String, Map<String, List<String[]>>> checkAndValidateSRData(MultipartFile excelFile){
        ...
        try{
            ...
            //Read Data
            excelData = readSRExcelDataAndValidate(excelData);
            if(excelData==null || excelData.isEmpty()){
    ...
    public List<String[]> readSRExcelDataAndValidate(List<String[]> excelData){
